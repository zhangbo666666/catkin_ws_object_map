...
int main(int argc, char **argv)
{
    ...
    SLAM.SaveKeyFrameTrajectoryTUM("/home/zb/dataset/435/KeyFrameTrajectory.txt");
    SLAM.SaveTrajectoryTUM("/home/zb/dataset/435/CameraTrajectory.txt");
    ...
    SLAM.SaveKeyFrameImagesAndTrajectory("/home/zb/dataset/435/trajectory.log");
...
RGBDNode::RGBDNode (ORB_SLAM2::System* pSLAM, ros::NodeHandle &node_handle, image_transport::ImageTransport &image_transport) :
    ...
    // rgb_subscriber_ = new message_filters::Subscriber<sensor_msgs::Image> (node_handle, "/orb_slam2_rgbd/keyframe_image_rgb", 1);

    //       depth_subscriber_ = new message_filters::Subscriber<sensor_msgs::Image> (node_handle, "/orb_slam2_rgbd/keyframe_image_depth", 1);
...
//    std::vector<Object2D> vecObjects;// 2D检测结�?
